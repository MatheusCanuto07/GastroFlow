...
<section class="">
	<div class="mx-auto flex items-center justify-center md:h-screen px-6 py-8 lg:py-0 ">
		<div class="w-1/2 rounded-lg bg-white shadow-2xl sm:max-w-md md:mt-0 xl:p-0 dark:border dark:border-gray-700 dark:bg-gray-800">
			<div class="space-y-4 p-6 sm:p-6 md:space-y-6">
